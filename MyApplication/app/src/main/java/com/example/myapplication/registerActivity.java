    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                validate = true; //검증 완료
                                //check_button.setBackgroundColor(ContextCompat.getColor(this,R.color.colorGray));
        ...
        join_button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //한 칸이라도 입력 안했을 경우
                if (UserEmail.equals("") || UserPwd.equals("") || UserName.equals("")|| PassCk.equals("")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(registerActivity.this);
                ...
                //서버로 Volley를 이용해서 요청
                com.example.myapplication.RegisterRequest registerRequest = new com.example.myapplication.RegisterRequest(UserEmail, UserPwd, UserName, responseListener);
                RequestQueue queue = Volley.newRequestQueue( registerActivity.this );
